...
(function () {
    ...
    gulp.task('copy.bundle.to.dist', function () {
        return gulp.src('./tmp/back-top.bundle.js').pipe(gulp.dest('./dist'));
    });

    gulp.task('bundle', function (cb) {
        var cmd = 'node_modules/.bin/rollup -c rollup.config.js dist/back-top.module.js > tmp/back-top.bundle.js';
